...
class UserGroupsTableViewController: UITableViewController {
    ...
    required init?(coder: NSCoder) {
        ...
        userGroups = fakeDb.getGroupsForCurrentUser()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.groupLabelTableCell.text = userGroups[indexPath.row].label
        if let groupAvatar = userGroups[indexPath.row].avatar {
            cell.groupAvatarTableCell.image = groupAvatar
        }
